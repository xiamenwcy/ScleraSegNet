...
parser.add_argument('--model', type=str, default='Sclera_miche.caffemodel') 
...
test_dir = '/data3/caiyong.wang/data/Sclera/MICHE/test/image/' # test images directory
save_mask_dir = join('/data3/caiyong.wang/ScleraSegNet/CBAM/test/MICHE/', splitext(split(args.model)[1])[0],'mask/') # directory to save results
